...
class Appuserstoken_model extends CI_Model
{
    ...
    public function get_Totalrequest()
    {
        ...
        $sql    = "	SELECT m.* FROM g_appusers_token m $where_sql Order By m.id desc ";
    ...
    public function get_appusers()
    {
        ...
        $sql    = "	SELECT m.* FROM g_appusers_token m $where_sql Order By m.id desc LIMIT $offset,$rows";
        $query        = $this->db->query($sql);
        $data        = $query->result_array();
        return $data;
    }
    ...
    public function select_appusers($id = '', $username = '')
    {
        ...
        $sql    = "	SELECT * FROM g_appusers_token $where_sql"; //where m.username =
        $query        = $this->db->query($sql);
        $data        = $query->result_array();
        return $data;
    }
    ...
    public function get_member()
    {
        ...
        $sql        = "SELECT * FROM `g_appusers_token`"; //where m.username =
        $query      = $this->db->query($sql);
        $data       = $query->result_array();
        return $data;
    }
    ...
    public function get_member_detail($id)
    {
        ...
        $sql        = "SELECT * FROM `g_appusers_token` where id =" . $id; //where m.username =
        $query      = $this->db->query($sql);
        $data       = $query->result_array();
        return $data;
    }
    ...
    public function last_id()
    {
        ...
        $sql = 'SELECT MAX(id) as id FROM g_appusers_token';
        $query        = $this->db->query($sql);
