...
class Email_model extends CI_Model
{
	...
	public function get_Totalrequest() {
        ...
        $sql	= "	SELECT m.* FROM M_giift_email m $where_sql Order By m.id desc ";
   	...
   	public function get_email() {
        ...
        $sql	= "	SELECT m.* FROM M_giift_email m $where_sql Order By m.id desc LIMIT $offset,$rows";
        $query		= $this->db->query($sql);
        $data		= $query->result_array();
        return $data;
    }
	...
	public function select_email($id='', $email='') {
        ...
        $sql	= "	SELECT m.* FROM M_giift_email m $where_sql";//where m.username =
        $query		= $this->db->query($sql);
        $data		= $query->result_array();
        return $data;
	}
