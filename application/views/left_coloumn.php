...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <?php if ($this->session->userdata['user_data_web']['role'] == 1) { ?>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview <?php if ($this->uri->segment(1) == 'emailsubscribe') {
                                            echo 'active';
                                        } ?>">
                <li <?php if ($this->uri->segment(1) == 'emailsubscribe') {
                            echo 'class="active"';
                        } ?>>
                    <a href="<?php echo $this->config->item('base_url'); ?>emailsubscribe"><i class="fa  fa-newspaper-o"></i> <span>Subscribe news letter</span></a>
                </li>
                </li>

                <li class="treeview <?php if ($this->uri->segment(1) == 'adjust_poin' || $this->uri->segment(1) == 'adjust_poin_member') {
                                            echo 'active';
                                        } ?>">
                    <a href="#">
                        <i class="fa fa-rub"></i> <span>Adjust Poin</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li <?php if ($this->uri->segment(1) == 'adjust_poin' && $this->uri->segment(2) == '') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>adjust_poin"><i class="fa   fa-plus-square-o"></i> <span>Adjust poin</span></a>
                        </li>
                        <li <?php if ($this->uri->segment(2) == 'adjust_poin_member') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>adjust_poin/adjust_poin_member"><i class="fa   fa-plus-square-o"></i> <span>Adjust poin member</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li <?php if ($this->uri->segment(1) == 'rule_new') {
                            echo 'class="active"';
                        } ?>>
                    <a href="<?php echo $this->config->item('base_url'); ?>rule_new"><i class="fa   fa-plus-square-o"></i> <span>New Rule Management</span></a>
                </li>
                <li>
                ...
                <li class="treeview <?php if ($this->uri->segment(1) == 'event_data' || $this->uri->segment(1) == 'event_list') {
                                            echo 'active';
                                        } ?>">
                    <a href="#">
                ...
                <li class="treeview <?php if ($this->uri->segment(1) == 'report' || $this->uri->segment(1) == 'report') {
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li <?php if ($this->uri->segment(1) == 'report' && $this->uri->segment(2) == 'report_rule_expire_poin_monthly') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>report/report_rule_expire_poin_monthly"><i class="fa  fa-circle-o"></i> <span> Report Poin Expired Monthly</span></a>
                        </li>
                        <li <?php if ($this->uri->segment(1) == 'report' && $this->uri->segment(2) == 'report_rule_expire_poin_daily') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>report/report_rule_expire_poin_daily"><i class="fa  fa-circle-o"></i> <span> Report Poin Expired Daily</span></a>
                        </li>
                        <li <?php if ($this->uri->segment(1) == 'report' && $this->uri->segment(2) == 'report_member_poin_serbu') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>report/report_member_poin_serbu"><i class="fa  fa-circle-o"></i> <span> Report Member Poin Serbu</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="treeview <?php echo $this->uri->segment(1) == 'merchantbtn' || ($this->uri->segment(1) == 'reportbtn' && $this->uri->segment(2) == 'redeem') ? 'active' : '' ?>">
                    <a href="#">
                        <i class="fa fa-files-o"></i> <span>Merchant BTN</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li <?php if ($this->uri->segment(1) == 'merchantbtn') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>merchantbtn"><i class="fa    fa-heart"></i> <span>Merchant List</span></a>
                        </li>
                        <li <?php if ($this->uri->segment(1) == 'reportbtn' && $this->uri->segment(2) == 'redeem') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>reportbtn/redeem"><i class="fa    fa-heart"></i> <span>Redeem Report</span></a>
                            </li>
                    </ul>
                </li>
                ...
                <li class="treeview <?php if ($this->uri->segment(1) == 'pagecontent') {
                                            echo 'active';
                                        } ?>">
                <li <?php if ($this->uri->segment(1) == 'pagecontent') {
                            echo 'class="active"';
                        } ?>>
                    <a href="<?php echo $this->config->item('base_url'); ?>pagecontent"><i class="fa   fa-plus-square-o"></i> <span>Page & Content</span></a>
                </li>
                </li>
                <li class="treeview <?php if ($this->uri->segment(1) == 'themes') {
                                            echo 'active';
                                        } ?>">
                <li <?php if ($this->uri->segment(1) == 'themes') {
                            echo 'class="active"';
                        } ?>>
                    <a href="<?php echo $this->config->item('base_url'); ?>themes"><i class="fa   fa-plus-square-o"></i> <span>Themes</span></a>
                </li>
                </li>
                <li class="treeview <?php if ($this->uri->segment(1) == 'setting' || $this->uri->segment(1) == 'sosial_media' || $this->uri->segment(1) == 'setting') {
                                            echo 'active';
                                        } ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li <?php if ($this->uri->segment(1) == 'setting') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>setting"><i class="fa   fa-cog"></i> <span>Setting</span></a>
                        </li>
                        <li <?php if ($this->uri->segment(1) == 'sosial_media') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>sosial_media"><i class="fa   fa-cog"></i> <span>Setting Sosial Media</span></a>
                        </li>
                        <li <?php if ($this->uri->segment(1) == 'setting') {
                                    echo 'class="active"';
                                } ?>>
                            <a href="<?php echo $this->config->item('base_url'); ?>setting/minimal_poin"><i class="fa fa-usd"></i> <span>Jumlah Minimal Poin </span></a>
                        </li>
        ...
        <?php } else if ($this->session->userdata['user_data_web']['role'] == 3) { ?>
            <ul class="sidebar-menu" data-widget="tree">
 ...
 -->
        ...
        <?php } else if ($this->session->userdata['user_data_web']['role'] == 5) { ?>
