	        ...
	        <div class="col-xs-12">
	        	<div class="box">
                  ...
                  <?php } ?>
		            	...
		            	<div style="float: right"><a href="<?php echo $this->config->item('base_url')?>email/create" class="btn btn-app"><i class="fa fa-plus"></i> Input</a></div>
		            	<?php } ?>
...
$(document).ready(function() {
	$('#member').DataTable( {
		...
		"bFilter": false,
        "ajax": "<?php echo $this->config->item('base_url'); ?>email/datatables",
		"type": "GET"
    } );
} );
