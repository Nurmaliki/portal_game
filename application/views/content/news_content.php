	        ...
	        <div class="col-xs-12">
	        	<div class="box">
		            ...
		            <div class="box-body">
		            	...
		            	<div style="float: right"><a href="<?php echo $this->config->item('base_url')?>news_content/create" class="btn btn-app"><i class="fa  fa-plus"></i> Input</a></div>
		            	<?php } ?>
	...
	$('#member').DataTable( {
        ...
        language: {
            ...
            processing: "<div style='    margin-top: 20%;   background-color: greenyellow;'><b>LOADING...</b></div>"
				...
				"bFilter": true,
        "ajax": "<?php echo $this->config->item('base_url'); ?>news_content/datatables",
		"type": "GET"
    } );
	// 	$("href").click(function() {
