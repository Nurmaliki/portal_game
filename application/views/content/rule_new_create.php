...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $this->config->item('base_url');?>role">Rule New</a></li>
    	...
    	<div class="row">
	        <div class="col-xs-12">
                ...
                <?php } ?>
		            ...
		            <!-- /.box-header -->
		            <!-- form start -->
		            <form role="form" action="<?php echo $this->config->item('base_url'); ?>rule_new/action_create" method="post">
		             	<div class="box-body">
                    ...
                    <div class="form-group">
			           ...
			           <!--  	<div class="form-group">
			                ...
			                <div class="form-group">
			                  ...
			                  <input type="number" required class="form-control" id="Nominal" placeholder="Enter nominal here" name="nominal" value="<?php echo $_SESSION['faild']['nominal']; ?>">
			                </div> -->
			                <!-- <div class="form-group">
			        ...
			        <!-- <div class="form-group">
                            ...
                            <div class="form-group">
			                  <label for="exampleInputEmail1">Description</label>
												<!-- <textarea required class="form-control" rows="3" placeholder="Enter description here" name="description"><?php echo $_SESSION['faild']['description']; ?></textarea> -->
			                  <!-- <input type="text" class="form-control" id="description" placeholder="Description here" name="description" value="<?php echo $_SESSION['faild']['description']; ?>">
							</div> -->
							<div class="form-group">
