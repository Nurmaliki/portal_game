...
<div class="content-wrapper">
    ...
    <section class="content">
        <h5 style="margin-left: 12px;" class="btn-actions hidden">Last Update :<?php echo $merchant[0]['last_update']; ?></h5>
        <div class="row">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
						            ...
						            // die();
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php echo $merchant[$i]['name']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $merchant[$i]['category']; ?>
                                                    </td>
                                                    <!-- <td>
                                                        <?php echo number_format($merchant[$i]['value'],0,",","."); ?>
                                                    </td> -->
                                                    <td>
                                                        <?php echo number_format($merchant[$i]['price'],0,",","."); ?>
                                                    </td>
                                                    <td>
                                                        <?php echo number_format($merchant[$i]['points'],0,",","."); ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $merchant[$i]['voucher_count']; ?>
                                                    </td>
                                                    <td>
                                                      <a href="<?php echo $this->config->item('base_url');?>/merchantbtn/detail/<?php echo $merchant[$i]['id']; ?>/<?php echo $merchant[$i]['type']; ?>" class="fa fa-fw fa-eye">&nbsp;
                                                      <?php if($merchant[$i]['type'] == 2){ ?>
                          <a href="#" onclick="saveMerchantId('<?php echo $merchant[$i]['name']; ?>','<?php echo $merchant[$i]['dmo_id']; ?>')" class="fa fa-fw fa-plus-square" style="margin-left:10px" title="Tambah voucher"></a>
                          <a href="<?php echo $this->config->item('base_url');?>/merchantbtn/update/<?php echo $merchant[$i]['id']; ?>/<?php echo $merchant[$i]['type']; ?>" class="fa fa-fw fa-pencil-square-o" style="margin-left:10px" title="Edit merchant"></a>
                          <a href="<?php echo $this->config->item('base_url');?>/merchantbtn/delete/<?php echo $merchant[$i]['id']; ?>/<?php echo $merchant[$i]['type']; ?>" class="fa fa-trash" style="margin-left:10px; color:red" title="Delete merchant"></a>
                        <?php } ?>
                                                    </td>
      ...
      <?php echo form_open_multipart($this->config->item('base_url').'/voucher/create', array('id' => 'manualVoucher'));?>
            ...
            <div class="form-group">
                ...
                <label for="">file size : 200kb , resolusi 180 x 120 px, file type : png,jpg </label>
								<div class="invalid-feedback">
              ...
              <!-- Date range -->
                ...
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" onchange="$('#category').val($(this).find(':selected').text());" data-select2-id="1" tabindex="-1" aria-hidden="true" required>
              ...
              <div class="form-group hidden">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="value" class="form-control pull-right numbers">
                </div>
              </div>
              <!-- /.form group -->
              ...
              <div class="form-group ">
                ...
                <div class="input-group">
                  ...
                  <input type="text"  name="price" class="form-control pull-right numbers" value="0">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text"  name="points" class="form-control pull-right numbers">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
			  ...
			  <div class="form-group">
                  ...
                  <textarea class="form-control editor" name="tc" rows="3" style="resize: none;" placeholder="Enter ..."></textarea>
            </div>

			<?php echo form_close(); ?>
            </div>
			<div class="box-footer">
			 <a class="btn btn-app" style="float:right" onclick="$('#manualVoucher').submit();">
...
$.ajax({
     ...
     data:new FormData(this), //penggunaan FormData
      ...
      if(resp['status']){
        ...
        alert(resp['message']);
        //$('#addVoucher').hide();$('#voucherList,.btn-actions').show();
        // location.reload();
      }
	   }
	 });
