...
">
    ...
    <div class="container">
        ...
        <center><ul class="pagination" style="margin-bottom:70px">
  <li><a href="<?php echo $this->config->item('base_url'); ?>welcome/index/0?access=<?php echo $_GET['access']; ?>">1</a></li>
  <li><a href="<?php echo $this->config->item('base_url'); ?>welcome/index/1?access=<?php echo $_GET['access']; ?>">2</a></li>
  <li><a href="<?php echo $this->config->item('base_url'); ?>welcome/index/2?access=<?php echo $_GET['access']; ?>">3</a></li>
  <li><a href="<?php echo $this->config->item('base_url'); ?>welcome/index/3?access=<?php echo $_GET['access']; ?>">4</a></li>
  <li><a href="<?php echo $this->config->item('base_url'); ?>welcome/index/4?access=<?php echo $_GET['access']; ?>">5</a></li>
</ul></center>
