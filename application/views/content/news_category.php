	        ...
	        <div class="col-xs-12">
	        	<div class="box">
		            ...
		            <div class="box-body">
		            	...
		            	<div style="float: right"><a href="<?php echo $this->config->item('base_url')?>news_category/create" class="btn btn-app"><i class="fa  fa-plus"></i> Input </a></div>
		            	<?php } ?>
...
$(document).ready(function() {
	$('#member').DataTable( {
		...
		"bFilter": false,
        "ajax": "<?php echo $this->config->item('base_url'); ?>news_category/datatables",
		"type": "GET"
    } );
} );
