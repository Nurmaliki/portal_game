...
<!-- member terdaftar -->
<!-- <div class="btn btn-info">member terdaftar :<?php // print_r($total_member);
                                                    ?></div> -->
...
<div class="content-wrapper">
    <?php if (
        $this->session->userdata['user_data_web']['role'] != 2 && $this->session->userdata['user_data_web']['role'] != 4
    ) { ?>
                        ...
                        <form style="display: flex;" role="form" action="<?php echo $this->config->item('base_url'); ?>welcome/analitics" method="post">
                            ...
                            <div style="padding: 10px 0 10px 0;margin-top:auto;margin-bottom:auto;">
                                <select class="form-control" name="program_code">
                                    ...
                                    <option value="point_daily" <?php if ($_SESSION["session_data"]['program_code'] == 'point_daily') {
                                                                    echo 'selected';
                                                                } ?>>Daily Point</option>
                                    <option value="point_weekly" <?php if ($_SESSION["session_data"]['program_code'] == 'point_weekly') {
                                                                        echo 'selected';
                                                                    } ?>>Weekly Point</option>
                                    <option value="point_monthly" <?php if ($_SESSION["session_data"]['program_code'] == 'point_monthly') {
                                                                        echo 'selected';
                                                                    } ?>>Monthly Point</option>
                                    <option value="point_distribution_redeem" <?php if ($_SESSION["session_data"]['program_code'] == 'point_distribution_redeem') {
                                                                                    echo 'selected';
                                                                                } ?>>Distribution Point Redeem</option>
                                    <option value="point_distribution_exchange" <?php if ($_SESSION["session_data"]['program_code'] == 'point_distribution_exchange') {
                                                                                    echo 'selected';
                                                                                } ?>>Distribution Point Exchange</option>
                            ...
                            <div style="padding: 10px 0 10px 5px;margin-top:auto;margin-bottom:auto;">
                                <div class="input-group date">
                                    ...
                                    <input type="text" required placeholder="Date Start" class="form-control pull-right" id="datepicker2" name="to_date" value="<?php if ($to_date != '') {
                                                                                                                                                                    echo $to_date;
                                                                                                                                                                } ?>">
                                </div>
                            </div>
                            ...
                            <div style="padding: 10px 0 10px 5px;margin-top:auto;margin-bottom:auto;">
                                <div class="input-group date">
                                    ...
                                    <input type="text" required placeholder="Date End" class="form-control pull-right" id="datepicker" name="from_date" value="<?php if ($from_date != '') {
                                                                                                                                                                    echo $from_date;
                                                                                                                                                                } ?>">
                                </div>
                            </div>
                            ...
                            <!-- </div> -->
                            <!-- member terdaftar -->
                            <!-- <div class="btn btn-info">member terdaftar :<?php //echo count($get_member);
                    ...
                    <table class="table table-hover">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <!-- <td><?php // echo date('Y-m-d', strtotime($member_transaction_history[$i]['transcode_btn_date'])); 
                                                ?></td> -->
                                    <!-- <td><?php //echo $member_transaction_history[$i]['transcode_btn_date']; 
                                                ?></td> -->
                                    ...
                                    <!-- <td><?php // echo date('Y-m-d', strtotime($member_transaction_history[$i]['exchange_date'])); 
                                                ?></td> -->
...
<script>
    ...
    var PieData = [
        //   {
        //     value    : <?php // echo $member_total_poin[0]['Total'];
                            ?>,//700,
        //     color    : '#f56954',
        //     highlight: '#f56954',
