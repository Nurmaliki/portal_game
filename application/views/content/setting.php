    	...
    	<div class="row">
	        <div class="col-xs-12">
	        	<div class="box">
		            ...
		            <div class="box-body">
                  <!-- Alert Tentang -->
                  <?php if($this->session->flashdata('alertSettingFalse')){ ;?>
                            <div style="width: 100%;" id="alerts" class="alert alert-success" role="alert">
                                <strong><?php echo $this->session->flashdata('alertSettingFalse');?></strong>
                            </div>
                  <?php }else if($this->session->flashdata('alertSettingTrue')){?>
                            <div style="background: #d4edda !important;color: #155724 !important;   width: 100%; " id="alerts" class="alert alert-success" role="alert">
                                <strong><?php echo $this->session->flashdata('alertSettingTrue');?></strong>
                            </div>
                  <?php } ?>
						<?php // if ($this->session->userdata['user_data_web']['role'] == 5) { ?>
								<!-- <div style="float: right"><a href="<?php echo $this->config->item('base_url')?>setting/create" class="btn btn-app"><i class="fa  fa-plus"></i> Input</a></div> -->
	...
	$('#member').DataTable( {
        ...
        language: {
            ...
            processing: "<div style='    margin-top: 20%;   background-color: greenyellow;'><b>LOADING...</b></div>"
				...
				"bFilter": true,
        "ajax": "<?php echo $this->config->item('base_url'); ?>setting/datatables",
		"type": "GET"
    } );
	// 	$("href").click(function() {
