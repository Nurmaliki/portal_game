	        ...
	        <div class="col-xs-12">
	        	<div class="box">
		            ...
		            <div class="box-body">
						...
						<?php } ;?>
						<form role="form" action="<?php echo $this->config->item('base_url'); ?>reportgiift/redeem" method="post">
		            	...
		            	<form role="form" action="<?php echo $this->config->item('base_url'); ?>reportgiift/download_redeem" method="post">
