	        ...
	        <div class="col-xs-12">
	        	<div class="box">
		            ...
		            <div class="box-body">
						...
						<form role="form" action="<?php echo $this->config->item('base_url'); ?>report/report_rule_all" method="post">
							...
							<?php //print_r($_SESSION)?>
                                ...
                                <?php
			                   	...
			                   	?>
									   ...
									   <?php if(trim($get_poin_code[$i]['poin_code'], "") == " 1001"){  ?>
									  ...
									  <?php ?>
									  <?php }else if(trim($get_poin_code[$i]['poin_code'], " ") == "1002"){  ?>
		            	...
		            	<!-- <form role="form" action="<?php // echo $this->config->item('base_url'); ?>report/download_redeem" method="post">
						...
						<?php
						 ...
						 ?>
						 		<tr>
									...
									<td><?php echo $get_poin_poincode_bydate[$i]['poin_code_ps']; ?></td>
