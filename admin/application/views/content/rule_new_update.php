    	...
    	<div class="row">
	        <div class="col-xs-12">
                ...
                <?php } ?>
		            ...
		            <!-- /.box-header -->
		            <!-- form start -->
		            <form role="form" action="<?php echo $this->config->item('base_url'); ?>rule_new/action_update" method="post"><input type="hidden" name="id" value="<?php echo $role[0]['id']; ?>">
		             	<div class="box-body">
                    ...
                    <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="description" placeholder="Name" name="description" value="<?php echo $role[0]['description']; ?>">
                    </div>
			                ...
			                <div class="form-group">
			                  ...
			                  <input type="text" class="form-control" id="Nominal" placeholder="Enter nominal here" name="nominal" value="<?php echo $role[0]['nominal']; ?>">
			                </div> -->
