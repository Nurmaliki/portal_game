    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <!-- </div> -->
                <!-- <div class="col"> -->
                <div style="float: right"><a data-confirm="Are you sure you want to Sync Giift Merchant ?" href="<?php echo $this->config->item('base_url')?>merchantgiift/sync_giift_list" class="btn btn-app btn-actions"><i class="fa fa-sync"></i>Update Merchants</a></div>
                <!-- </div> -->
                <!-- <div class="col"></div> -->
                <!-- </div> -->
                ...
                <div class="col-xs-12" id="voucherList" style="display:block">
                      <!-- Alert Tentang -->
                      <?php if($this->session->flashdata('merchantGiiftFalse')){ ;?>
                        <div style="width: 100%;" id="alerts" class="alert alert-success" role="alert">
                            <strong><?php echo $this->session->flashdata('merchantGiiftFalse');?></strong>
                        </div>
                      <?php }else if($this->session->flashdata('merchantGiiftTrue')){?>
                            <div style="background: #d4edda !important;color: #155724 !important;   width:100%;" id="alerts" class="alert alert-success" role="alert">
                                <strong><?php echo $this->session->flashdata('merchantGiiftTrue');?></strong>
                            </div>
                      <?php } ?>
                            <div class="box">
                                <!-- /.box-header -->
                                <div class="box-body">
						            ...
						            // die();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      <a href="<?php echo $this->config->item('base_url');?>/merchantgiift/detail/<?php echo $merchant[$i]['id']; ?>/<?php echo $merchant[$i]['type']; ?>" class="fa fa-fw fa-eye">&nbsp;
                          ...
                          <a href="<?php echo $this->config->item('base_url');?>/merchantgiift/update/<?php echo $merchant[$i]['id']; ?>/<?php echo $merchant[$i]['type']; ?>" class="fa fa-fw fa-pencil-square-o" style="margin-left:10px" title="Edit merchant"></a>
                        <?php } ?>
                                                    </td>
