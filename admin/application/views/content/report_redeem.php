	        ...
	        <div class="col-xs-12">
	        	<div class="box">
		            ...
		            <div class="box-body">
						...
						<?php } ;?>
						<form role="form" action="<?php echo $this->config->item('base_url'); ?>report/redeem" method="post">
						...
						<?php
						 ...
						 ?>
						 		<tr>
						  			...
						  			<td><?php echo $report[$i]['merchant']; ?></td>
									<td><?php echo $report[$i]['transcode_btn']; ?></td>
			                  		<td class="badge bg-red"><?php echo $report[$i]['transcode_btn_poin']; ?></td>
			                  		<td><?php echo $report[$i]['transcode_btn_date']; ?></td>
									<td><?php echo $report[$i]['redeem_code']; ?></td>
									<td class="badge bg-green"><?php echo $report[$i]['redeem_poin']; ?></td>
									<td><?php echo $report[$i]['redeem_date']; ?></td>
								</tr>
						<?php
						  		}
						  	}else{
