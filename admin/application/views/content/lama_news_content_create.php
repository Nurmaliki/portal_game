    ...
    <section class="content">
		            ...
		            <!-- /.box-header -->
                        <!-- form start -->
                            ...
                            <div class="box-body" style="">
                                ...
                                <?php }else{?>
                                    <form role="form" action="<?php echo $this->config->item('base_url'); ?>news_content/action_create" method="post" 
                                     id="news_content" enctype="multipart/form-data" >
                                <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="Enter name here" name="name" value="<?php echo $field['title']; ?>">
                                    ...
                                    <input type="text" class="form-control" id="sub_title" placeholder="Enter Sub title here" name="sub_title" value="<?php echo $field['sub_title']; ?>">
                                    ...
                                    <div>
                                        ...
                                        <br>
                                        <textarea name="body" id="body" form="news_content" class="form-control"><?php echo $field['body']; ?></textarea>
                                    </div>
        ...
        <div class="box" >
            ...
            <div class="box-body" style="">
                ...
                <input type="file" name="userfile" size="20" form="news_content"/>
