	        ...
	        <div class="col-xs-12">
	        	<div class="box box-primary">
		            ...
		            <input type="hidden" id="id" name="id" value="<?php echo $content[0]['id']; ?>">
		              <div class="box-body">
		                ...
		                <div class="form-group">
		                  ...
		                  <input type="text" class="form-control" id="name" placeholder="Enter Title here" name="name" value="<?php echo $content[0]['title']; ?>">
		                </div>

                        <div class="form-group">
		                  <label for="exampleInputEmail1">sub title</label>
		                  <input type="text" class="form-control" id="sub_title" placeholder="Enter Sub title here" name="sub_title" value="<?php echo $content[0]['sub_title']; ?>">
		                </div>

		                <div class="form-group">
		                  <label for="exampleInputEmail1">Body</label>
		                  <input type="textarea" class="form-control" id="body" placeholder="your story" name="body" value="<?php echo $content[0]['body']; ?>">
		                </div>
		                <div class="form-group">
                    ...
                    <div class="form-group">
		                  ...
		                  <input type="text" class="form-control" id="status" placeholder="publih / un publish" name="publish_by" value="<?php echo $content[0]['publish_by']; ?>">
										</div>
										<div class="form-group"> 
											...
											<br>
												...
												<?php }else{ ?>
													<textarea name="picture" id="picture" class="form-control" ><?php echo $path; ?></textarea>
												<?php }?>
										</div>
										<div class="form-group">
									...
									<div class="box" >
											...
											<div class="box-body" style="">
													...
													<?php if (empty($field['picture'])){ ?>
														<img class="img-responsive pad" src="<?php echo $content[0]['picture']; ?>" alt="Photo">
													<?php }else{ ?>
														<img class="img-responsive pad" src="<?php echo $field['picture']; ?>" alt="Photo">
