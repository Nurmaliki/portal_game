...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo $this->config->item('base_url'); ?>news_content">Game Content</a></li>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<form role="form" action="<?php echo $this->config->item('base_url'); ?>news_content/action_update/" method="post" enctype="multipart/form-data">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Game Content title</label>
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Game Content sub title</label>
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Game Content Body</label>
						...
						<div class="box">
							...
							<div class="box-body" style="">
								...
								<input type="file" id="inp" name="userfile" size="20" />

								<br /><br />
								<input type="hidden" id="upload" name="upload" value="" class="upload">
								<input type="text" id="b64" name="picture" value="" class="upload">
								<img id="imgext" src="<?php echo $content[0]['picture']; ?>" alt="" src="">
								<img id="img" src="" alt="" src="">
