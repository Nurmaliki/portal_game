    	...
    	<div class="row">
	        <div class="col-xs-12">
                ...
                <?php } ?>
		            ...
		            <!-- /.box-header -->
		            <!-- form start -->
		            <form role="form" action="<?php echo $this->config->item('base_url'); ?>rule_new/action_update_transcode/<?php echo $this->uri->segment(3); ?>" method="post">
		             	<div class="box-body">

			            	<div class="form-group">
			                  <label for="exampleInputEmail1">Transcode</label>
			                  <input type="number" required class="form-control" id="transcode" placeholder="Enter transcode here" name="transcode" value="<?php echo $get_transcode_by_id[0]['transcode'] ?>">
			                  <input type="hidden" required class="form-control" id="rule_id" name="rule_id" value="<?php echo $get_transcode_by_id[0]['rule_id']  ?>">
			                </div>
