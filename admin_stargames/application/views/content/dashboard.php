 ...
 <div class="row">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="stats-point-today">
               	<center><?php echo $poin_today; ?></center>
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Redeem Point </span>
              <span class="info-box-number" id="stats-point-redeem">
               	<center><?php echo $reddem_poin; ?></center>
                 </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <!-- /.col -->
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <span class="info-box-number" id="stats-point-member_website">
                        <center><?php echo $jumlah_aktif; ?> </center>
                    </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                    <span class="info-box-text">Today User Login</span>
                    <span class="info-box-number" id="stats-point-member_website">
                        <center><?php echo $jumlah_user_login_hari_ini; ?> </center>
                    </span>
                    </div>
