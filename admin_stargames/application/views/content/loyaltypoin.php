...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo $this->config->item('base_url'); ?>province">Konfigurasi</a></li>
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<?php if ($this->session->userdata['user_data']['role'] == 5) {
							...
							<div style="float: right"><a href="<?php echo $this->config->item('base_url') ?>loyaltypoin/create" class="btn btn-app"><i class="fa fa-plus"></i> Input</a></div>
						<?php } ?>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#member').DataTable({
			...
			"bFilter": false,
			"ajax": "<?php echo $this->config->item('base_url'); ?>loyaltypoin/datatables",
			"type": "GET"
		});
	});
