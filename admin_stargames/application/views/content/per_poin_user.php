...
<div class="content-wrapper">
    ...
    User Poin Activity
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">User Poin Activity</li>
      </ol>
    </section>
	        ...
	        <div class="col-xs-12">
	        	<div class="box">
		            ...
		            <div class="box-body">
						...
						<?php } ;?>
						<form role="form" action="<?php echo $this->config->item('base_url'); ?>reportmember/per_poin_user" method="post">
		            	...
		            	<form role="form" action="<?php echo $this->config->item('base_url'); ?>reportmember/download_per_poin_user" method="post">
