...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">User Login Activity</li>
      </ol>
    </section>
	        ...
	        <div class="col-xs-12">
	        	<div class="box">
		            ...
		            <div class="box-body">
						...
						<?php } ;?>
						<form role="form" action="<?php echo $this->config->item('base_url'); ?>reportmember/akt_login_user" method="post">
		            	...
		            	<form role="form" action="<?php echo $this->config->item('base_url'); ?>reportmember/download_akt_login_user" method="post">
						...
						<?php
						 ...
						 ?>
						 		<tr>
						  			...
						  			<td><?php echo $report[$i]['date_login']; ?></td>
